...
public class MainActivity extends AppCompatActivity {
    ...
    private Switch mSwitchNyala;
    private Switch mSwitchCharge;
    private Switch mPeriodeSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwitchNyala = (Switch) findViewById(R.id.Switchnyala);
        mSwitchCharge = (Switch) findViewById(R.id.Switchcharger);
        mPeriodeSwitch = (Switch) findViewById(R.id.periodicSwitch);

        mSeekBar = (SeekBar) findViewById(R.id.seekBar);

        Button scheduleJobButton = (Button) findViewById(R.id.btn_job);
        Button cancelJobButton = (Button) findViewById(R.id.btn_cancel);
        ...
        mPeriodeSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    private void scheduleJob() {
        ...
        RadioGroup networkOptions = (RadioGroup) findViewById(R.id.Opsijaringan);

        int selectedNetworkID = networkOptions.getCheckedRadioButtonId();

        int selectedNetworkOption = JobInfo.NETWORK_TYPE_NONE;
        switch(selectedNetworkID){
            case R.id.tidakNetwork:
                selectedNetworkOption = JobInfo.NETWORK_TYPE_NONE;
                break;
            case R.id.mobileNetwork:
        ...
        JobInfo.Builder builder = new JobInfo.Builder(JOB_ID, serviceName)
                ...
                .setRequiresDeviceIdle(mSwitchNyala.isChecked())
                .setRequiresCharging(mSwitchCharge.isChecked());

        int seekBarInteger = mSeekBar.getProgress();
        boolean seekBarSet = seekBarInteger > 0;

        if (mPeriodeSwitch.isChecked()){
            if (seekBarSet){
        ...
        boolean constraintSet = selectedNetworkOption != JobInfo.NETWORK_TYPE_NONE
                || mSwitchCharge.isChecked() || mSwitchNyala.isChecked()
                || seekBarSet;
